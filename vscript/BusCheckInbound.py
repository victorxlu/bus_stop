...
def BusCheckInbound(BusNumber):
  ...
  result=[]
  result_BusCheckInbound = pd.merge(bus_df, stop_df, how='left' , on=["stop"])

  return result_BusCheckInbound
